---
id: 2
title: Commit and PR Calculator Feature
stage: misc
date: 2025-11-28
surface: agent
...
labels: ["git", "commit", "pull-request", "feature"]
links:
  spec: null
  ticket: null
  adr: null
  pr: https://github.com/malikinzimam/Calculator-gemini/pull/new/001-basic-calculator-app
files:
  - .specify/memory/constitution.md
  - .specify/templates/plan-template.md
  - history/prompts/constitution/2-update-constitution-for-powerful-mobile-calculator.constitution.prompt.md
  - specs/001-basic-calculator-app/spec.md
  - specs/001-basic-calculator-app/plan.md
  - history/prompts/001-basic-calculator-app/1-generate-calculator-spec.spec.prompt.md
  - history/prompts/001-basic-calculator-app/2-commit-and-pr-calculator-feature.misc.prompt.md
tests:
  - none
---
